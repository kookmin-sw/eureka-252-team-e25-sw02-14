...
> **배운 점:** "이 기술이 실제로 존재하나요?"라는 질문을 통해, 공학적 기술뿐만 아니라 디자인과 기획이 어우러져야 비로소 사람들을 설득할 수 있다는 **협업의 가치**를 체감했습니다.
...
### 🔗 우간바야르 (소프트웨어전공)
> "웹 기술이 단순히 정보를 보여주는 것을 넘어, 사람들에게 미래를 생생하게 체험하게 하는 도구가 될 수 있다는 것을 느꼈습니다. Future Vision Day에서 사람들이 우리 포스터를 보고 눈을 반짝이며 질문하는 모습에 큰 보람을 느꼈습니다. 앞으로도 **사용자가 편안함을 느끼는 서비스를 만드는 개발자**가 되고 싶습니다."
